...
class SunflowerBottomCropBlock(settings: Settings) : TallFlowerBottomCropBlock(settings) {
    override fun getMidShape(): VoxelShape = createColumnShape(6.0, 0.0, 16.0);
    override fun getUpperBlock(): Block = ModBlocks.sunflowerCrop_.top_;
    override fun getSeedsItem(): ItemConvertible = ModItems.sunflowerSeeds_;
}